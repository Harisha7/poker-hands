...
test('test that checkDuplicate returns truthy if does not contain duplicate cards', () => {
...
test('test that checkDuplicate returns falsy if does contain duplicate cards', () => {
