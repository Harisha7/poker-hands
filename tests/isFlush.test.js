...
test('test that isFlush returns truthy if flush', () => {
...
test('test that isFlush returns falsey if not flush', () => {
...
test('test that isFlush returns a higher score for a stronger hand (if two hands but with flush)', () => {
